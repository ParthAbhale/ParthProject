...
function preload() {
    ...
    sGroundImg = loadImage("lastground.jpg")
    sGroundImg1 = loadImage("2.jpg")
    sGroundImg2 = loadImage("groun.jfif")
    sGroundImg3 = loadImage("ground2.jfif")
    sGroundImg4 = loadImage("ground4.jfif")
}
